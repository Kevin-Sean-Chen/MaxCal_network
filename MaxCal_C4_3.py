# -*- coding: utf-8 -*-
"""
Created on Fri Apr  5 18:04:01 2024
...
synaptic_inputs = np.zeros((N4, timesteps))
spike_times = []
firing = []
...
for t in range(1, timesteps):
    ...
    v_neurons[:, t] = v_neurons[:, t - 1] + dt/tau*(v_rest - v_neurons[:, t - 1]) + np.random.randn(N4)*noise_amp
...
plt.title('mutual inhibition with common input (B=20)', fontsize=20)
